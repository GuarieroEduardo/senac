...
class Produto:
    def __init__(self, nome, preco):
        self.nome = nome
        self.preco = float(preco)  # Erro 1: garantir entrada de numeros quebrados
...
class Venda:
    def __init__(self, vendedor, produto, comissao):
        ...
        self.comissao = produto.preco * (comissao / 100.0)  # Erro 2: calculo de porcentagem
...
class SistemaComissao:
    ...
    def cadastrar_vendedor(self):
        ...
        for v in self.vendedores:
            if v.nome == nome:
                ...
                return  # Erro 3: usar return para retorna a mensagem

        vendedor = Vendedor(nome)
        self.vendedores.append(vendedor)  # Erro 4: cadastra o vendedor, não "nome"
    ...
    def cadastrar_produto(self):
        ...
        self.produtos.append(produto)  # Erro 5: cadastra o produto
    ...
    def cadastrar_venda(self):
        ...
        for v in self.vendedores:
            if v.nome == nome_vendedor:
                vendedor_encontrado = v  # Erro 6: corrigindo estrutuda do "for"
                break
        ...
        if not self.produtos:
            print("Nenhum produto cadastrado.")  # Erro 7: tem verificar produtos tambem
            return
        ...
        if self.comissao_geral is None:
            ...
            return  # Erro 8: verificar se comissão exite
    ...
    def relatorio_vendas(self):
        if len(self.vendas) == 0:
            ...
            for venda in self.vendas:
                print(f"{venda.vendedor.nome} vendeu {venda.produto.nome} por {venda.produto.preco}")  # Erro 9: precisa usar .nome
        ...
        for v in self.vendedores:
            if v.nome == nome:
                for venda in v.vendas:
                    total += venda.comissao  # Erro 10: estava somando objeto Produto
    ...
    def menu(self):
        ...
        while not sair:
            ...
            # Erro 11: input retorna string, não inteiro
            if opcao == "1": 
