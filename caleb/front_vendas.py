...
def configurar_placeholder(entry, placeholder):
    ...
    entry.bind("<FocusIn>", on_focusout)
...
def abrir_login():
    ...
    tk.Label(login_frame, text="Senha:", font=("Arial", 12), bg="black", fg="white", anchor="w").pack(fill="x", padx=34, pady=5)
    global senha_entry  # Cria a variável global para o campo de email
    senha_entry = tk.Entry(login_frame, width=35, font=("Arial", 12), show="*")  # Cria o campo de entrada de email
    senha_entry.pack(pady=5)
    configurar_placeholder(senha_entry, "Digite seu email")
