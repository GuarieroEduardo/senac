# Generated by Django 4.2.19 on 2025-06-06 01:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_carrinho', models.DecimalField(decimal_places=2, max_digits=8)),
            ],
        ),
        migrations.CreateModel(
            name='Cliente',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_prod', models.CharField(choices=[('Perecivel', 'Perecível'), ('Congelado', 'Congelado'), ('Nao_Perecivel', 'Não Perecível')], max_length=16)),
                ('descricao_pro', models.TextField(blank=True, max_length=350)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedido', models.CharField(choices=[('Pendente', 'Pendente'), ('Concluido', 'Concluído')], default='Pendente', max_length=10)),
                ('data_compra', models.DateTimeField(auto_now_add=True)),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comprador', to=settings.AUTH_USER_MODEL)),
